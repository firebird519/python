...
class Firefox:
    def __init__(self, cookie_file=None):
        ...
        self.session_file = os.path.join(os.path.dirname(cookie_file), 'sessionstore-backups/recovery.js')
	############################################################################	
	# this js can not be found. change another [2015.7.14]
